    ...
    <AnimatePresence>
      {step === 3 ? (
        ...
        <div className="flex w-full flex-col md:flex-row md:overflow-hidden">
          ...
          <div className="flex min-h-[60vh] w-full flex-col justify-center bg-[#FCFCFC] px-4 pb-8 pt-2 md:h-screen md:w-1/2 md:px-0 md:py-2">
            <div className="flex h-full w-full flex-col items-center justify-center">
              {step === 1 ? (
                ...
                >
                  ...
                  <p className="my-4 text-[14px] font-normal leading-[20px] text-[#1a2b3b]">
