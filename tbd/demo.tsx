    ...
    if (recordedChunks.length) {
      ...
      const questions: QuestionType = {
        ...
        Wealth: {
          ...
          Sarah:
            "Can you please explain the reason for the large transaction(s) in your account recently?",
        },
      };

      const question =
        questions[selected.name] &&
      ...
      if (upload.ok) {
        ...
        if (results.transcript.length > 0) {
          ...
          const prompt = `Please review the following due diligence question: ${question} and the transcript of the customer's response: ${
            results.transcript
          }. ${
            selected.name === "Business"
              ? "Please provide feedback on the customer's comprehension of business-related matters. Ensure their responses are clear, structured, and relevant to the question."
    ...
    <AnimatePresence>
      {step === 3 ? (
        <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden bg-[#FCFCFC] px-4 pb-8 pt-2 md:px-8 md:py-2">
          <p className="absolute top-0 -ml-4 flex h-[60px] w-full flex-row justify-between md:-ml-8">
            <span className="text-sm font-medium text-[#1a2b3b]">
              bilic demo
            </span>
            <span className="text-sm font-medium text-[#1a2b3b] opacity-20">
              bilic demo
            </span>
            <span className="text-sm font-medium text-[#1a2b3b]">
              bilic demo
            </span>
            <span className="hidden text-sm font-medium text-[#1a2b3b] opacity-20 sm:block">
              bilic demo
            </span>
            <span className="hidden text-sm font-medium text-[#1a2b3b] sm:block">
              bilic demo
            </span>
            <span className="hidden text-sm font-medium text-[#1a2b3b] opacity-20 xl:block">
              bilic demo
            </span>
            <span className="hidden text-sm font-medium text-[#1a2b3b] opacity-20 sm:block">
              bilic demo
            ...
            <div className="mx-auto mt-[10vh] flex w-full max-w-[1080px] flex-col overflow-y-auto pb-8 md:pb-12">
              ...
              >
                ...
                <div className="mt-8">
                  ...
                  <div className="mt-4 flex min-h-[100px] gap-2.5 rounded-lg border border-[#EEEEEE] bg-[#FAFAFA] p-4 text-sm leading-6 text-gray-900">
                    <p className="prose prose-sm max-w-none">
                      {/* {`Business-name: ${extracted[0].business_name}`} */}
                      {extracted[0].map((item: any, index: number) => (
                        <div key={index}>
                          <p>Buinsess-name: {item.business_name}</p>
                          <p>Business-age: {item.business_age}</p>
                          <p>Buinsess-activity: {item.business_activity}</p>
                          <p>Business-customers: {item.business_customers}</p>
                          <p>Buinsess-location: {item.business_place}</p>
                        </div>
                      ))}
                    </p>
                  </div>
                </div>
                <div className="mx-auto my-0 mt-6 w-fit">
                  <Link
                    href="/"
                    className="group flex scale-100 items-center justify-center rounded-full bg-green-400 px-4 py-2 text-[13px] font-extrabold text-[#fff] no-underline transition-all duration-75 active:scale-95 "
                    style={{
                  ...
                  <h2>
                    ...
                    selectedInterviewer.name === "John"
                      ...
                      : selected.name === "Wealth" &&
                        selectedInterviewer.name === "John"
                      ? "What is the source of your initial capital or wealth?"
                      : selected.name === "Wealth" &&
                        selectedInterviewer.name === "Sarah"
                      ? "Can you please explain the reason for the large transaction(s) in your account recently?"
                      : "Please select a valid category or interviewer"}
                  </h2>

                  <span className="mb-4 text-[14px] font-normal leading-[20px] text-[#1a2b3b]">
                    Can help us understand your business even more
                  </span>
                  <motion.div
                    initial={{ y: -20 }}
                    animate={{ y: 0 }}
                    ...
                    className="relative aspect-[16/9] w-full max-w-[1080px] overflow-hidden rounded-lg bg-[#1D2B3A] shadow-md ring-1 ring-gray-900/5"
                  >
                    {!cameraLoaded && (
                        ...
                        <div className="absolute left-auto right-[10px] top-[10px] z-20 block aspect-video h-[80px] rounded sm:right-[20px] sm:top-[20px] sm:h-[140px] md:right-10 md:h-[180px] lg:top-[40px]">
                          <div className="aspect-video h-full w-full rounded md:rounded-lg lg:rounded-xl">
                            <video
                              ...
                              ref={vidRef}
                              playsInline
                              className="aspect-video h-full w-full rounded-md object-cover md:rounded-[12px]"
                              crossOrigin="anonymous"
                            >
                              <source
                                src={
                                  selectedInterviewer.name === "John"
                                    ? selected.name === "Business"
                                      ? "/video/john-business.mp4"
                                      : "/video/john-wealth.mp4"
                                    : selectedInterviewer.name === "Richard"
                                    ? selected.name === "Business"
                                ...
                                //   selectedInterviewer.name === "John"
                                //     ? selected.name === "Business"
                                //       ? "https://files.movio.la/aws_pacific/avatar_tmp/819c0738bd894693b2587ed2d538dc03/56855d4c20bc45628dbc0d61550c0f14.mp4?Expires=1687737436&Signature=QM9BL7ym-WqJ8Gh-qYyyE0lZBvELcwychSISKNJLmWc0l-QRjIKGFiixA4DTBB~knrSP82Zq7SyGvGjQuNJM-tPCMSmDKZ0HL~LyhClK3MJftL7C2cOYomW715YwJTUb9SW5qwbKKB92jd~yd6UWmTIEAvCsqAC-HE3bybYCz8Hvoa4wRn~0VL3MCQ0KmC6yEmNE4xVnCbFXfxCb9xTkxNXH9rtN3DpJmMVsjlNHPzTn4VsotEpIw0XcNUd3uYCGIPa5ViR~WVf68NXLgJo6EJz9cBAwDP6R8rkPoA-Jc~kfr0OaaoF7MzzaMs7a7uo8EzhyTe0PXrko0JPfrWn7Xw__&Key-Pair-Id=K49TZTO9GZI6K"
                                //       : "https://files.movio.la/aws_pacific/avatar_tmp/819c0738bd894693b2587ed2d538dc03/0a024a3141094227a65c6bd881a5d26e.mp4?Expires=1687738986&Signature=psEOzW5yrBKh2bHI6aBZqZJoEqeNAgjedJwtpBfe9R1baeeEZF03faZFi2qLfXC0cSA99iGZptlBHOmN-v6hyc~1aegnJkYK0tgG6PAnRQY6QQAxq~yiauNZ0MB4dxzUC5BxNOeIewQ~m3V1~NHvMHLTrOzmt3UKqtYKGUA7T~hS-FHu2CB9o7xe3vl~T364w86nRpjpKDUC0IfyP1725c1H4sHpANq3hy0uVYbZCNS9ngG-x4yhlI1~UuMdVTqvzj185PkijDhmCbMUUIJ0-G~UagcGx1RfHCLTF7OhvITg6M-xRw0b0n7kpscfdwZBKt9tT-pwVMndTBj4AkcdJQ__&Key-Pair-Id=K49TZTO9GZI6K"
                                //     : selectedInterviewer.name === "Richard"
                                //       ? selected.name === "Business"
                                //         ? "https://liftoff-public.s3.amazonaws.com/RichardBehavioral.mp4"
                                //         : "https://liftoff-public.s3.amazonaws.com/RichardTechnical.mp4"
                                //       : selectedInterviewer.name === "Sarah"
                                //         ? selected.name === "Business"
                                //           ? "https://files.movio.la/aws_pacific/avatar_tmp/819c0738bd894693b2587ed2d538dc03/d34d0b88ac254eaaa65db1698bb30b08.mp4?Expires=1687739714&Signature=D7ekNhPpG6POaJSo6u56nJq6kaY8o5UQYYl8J7foq2eMeDEdX6J7hFvVz~xYtq874t1VqAd0iPBK~VmP9Bv0iRHv3VQvl7blN4GEqMoDQ0BJ7ACQZ-Bq-ztpIR4a0EBE6JIbSgH-jGEsTL4HVXAj9DqeLj2WnHIdcZ6XjnAdxXoVeoaj~NfpR4gLE8wJQMzptN6M8dRWumiHfNcwTszDm07PYTQ4ovg9dnmV4ryn7GcG1dEDj6h2msLZ5i4GmARWXKo8BvF554rpEDIpye2zn6TT232YgiXY9t-AMqtK8br4NMJlW-5hn7300ThRUybPy3KP1pqcU8L54h5aqLLx2A__&Key-Pair-Id=K49TZTO9GZI6K"
        ...
        <div className="flex w-full flex-col md:flex-row md:overflow-hidden">
          <motion.p
            ...
            className="absolute top-0 flex h-[60px] w-full flex-row justify-between md:w-1/2"
          >
            <span className="text-sm font-medium text-[#fff]">bilic demo</span>
            <span className="text-sm font-medium text-[#fff] opacity-20">
              bilic demo
            </span>
            <span className="text-sm font-medium text-[#fff]">bilic demo</span>
            <span className="hidden text-sm font-medium text-[#fff] opacity-20 sm:block">
              bilic demo
            </span>
            <span className="hidden text-sm font-medium text-[#fff] sm:block">
              bilic demo
            </span>
            <span className="hidden text-sm font-medium text-[#fff] opacity-20 xl:block">
              bilic demo
            </span>
          </motion.p>
          <div className="flex min-h-[60vh] w-full flex-col justify-center bg-[#000] px-4 pb-8 pt-2 md:h-screen md:w-1/2 md:px-0 md:py-2">
            <div className="flex h-full w-full flex-col items-center justify-center">
              {step === 1 ? (
                <motion.div
                  ...
                  className="mx-auto max-w-lg px-4 lg:px-0"
                >
                  <h2 className="text-4xl font-bold text-[#fff]">
                    Select a type of Dilligence
                  </h2>
                  <p className="my-4 text-[14px] font-bold leading-[20px] text-[#fff]">
                    We have designed this specific section based on your
                    profile, financial activities, geographical location, and
                    risk score.
                  </p>
                  <div>
                          ...
                          >
                            {({ active, checked }) => (
                              <>
                                ...
                                <RadioGroup.Description
                                  as="span"
                                  className="ml-4 mt-0 flex flex-col items-center justify-center text-right text-sm"
                                >
                  ...
                  <div className="mt-8 flex justify-end gap-[15px]">
                    <div>
                      <Link
                        href="/"
                    ...
                    <div>
                      <button
                        ...
                        className="hover:[linear-gradient(0deg, rgba(255, 255, 255, 0.1), rgba(255, 255, 255, 0.1)), #0D2247] group flex flex scale-100 items-center justify-center gap-x-2 rounded-full bg-[#1E2B3A] px-4 py-2 text-[13px] font-semibold text-white no-underline  transition-all duration-75 active:scale-95"
                        style={{
                          boxShadow:
                            "0px 1px 4px rgba(13, 34, 71, 0.17), inset 0px 0px 0px 1px #061530, inset 0px 0px 0px 2px rgba(255, 255, 255, 0.1)",
                        }}
                ...
                >
                  ...
                  <p className="my-4 text-[14px] font-normal leading-[20px] text-[#fff]">
          ...
          <div className="relative h-[40vh] w-full overflow-hidden bg-[#F1F2F4] md:h-screen md:w-1/2">
            <svg
              id="texture"
            ...
            <figure
              className="absolute left-1/2 z-20 ml-[-380px] grid h-[540px] w-[760px] origin-[50%_15%] scale-[0.5] transform overflow-hidden rounded-[15px] bg-[#f5f7f9] p-2 text-[9px] sm:scale-[0.6] md:top-1/2 md:-mt-[240px] md:ml-[0px] md:origin-[50%_25%] md:scale-[130%]"
              style={{
            ...
            >
              <div className="absolute z-20 h-full w-full cursor-default bg-transparent"></div>
              <div
                className="relative flex flex-col rounded-lg bg-white p-[18px] text-[#1a2b3b]"
              ...
              >
                <ul className="mb-auto list-none">
                  ...
                  <li className="mt-4 flex list-none items-center rounded-[9px] py-[2px] text-gray-900">
                    <svg
                  ...
                  <li className="mt-1 flex list-none items-center rounded-[9px] py-[4px] text-gray-900">
                    <svg
                      fill="none"
                      viewBox="0 0 24 24"
                      className="h-4 w-4 text-gray-700"
                    ...
                    <div className="ml-auto transform text-[#121217]">
                      <svg
                        width="24"
                        height="24"
                        fill="none"
                        viewBox="0 0 24 24"
                        className="h-3 w-3 rotate-180 transform fill-transparent stroke-current"
                      >
                        <path
                          stroke="currentColor"
                          strokeLinecap="round"
                  ...
                  <li className="relative m-0 mt-1 flex w-full cursor-pointer list-none items-center rounded-[3px] bg-white py-[4px] text-gray-600 hover:bg-[#F7F7F8] focus:outline-none">
                    <div className="pointer-events-none absolute left-[7px] top-1/2 z-10 h-[3px] w-[3px] -translate-y-1/2 transform rounded-full bg-[#e8e8ed]"></div>
                    <div className="truncate pl-[18px] pr-4 text-gray-600">
                      All Interviews
                    </div>
                    <div className="absolute bottom-0 left-[8px] top-[9px] w-[1px] bg-[#e8e8ed]"></div>
                  </li>
                  <li className="relative m-0 flex w-full cursor-pointer list-none items-center rounded-[3px] bg-white py-[4px] text-gray-600 hover:bg-[#F7F7F8] focus:outline-none">
                    <div className="pointer-events-none absolute left-[7px] top-1/2 z-10 h-[3px] w-[3px] -translate-y-1/2 transform rounded-full bg-[#e8e8ed]"></div>
                    <div className="truncate pl-[18px] pr-4 text-gray-600">
                      Completed
                    </div>
                    <div className="absolute bottom-0 left-[8px] top-0 w-[1px] bg-[#e8e8ed]"></div>
                  </li>
                  <li className="relative m-0 flex w-full cursor-pointer list-none items-center rounded-[3px] bg-gray-100 py-[4px] text-gray-600 hover:bg-[#F7F7F8] focus:outline-none">
                    <div className="pointer-events-none absolute left-[7px] top-1/2 z-10 h-[3px] w-[3px] -translate-y-1/2 transform rounded-full bg-blue-600"></div>
                    <div className="truncate pl-[18px] pr-4 text-blue-600">
                      Question Bank
                    </div>
                    <div className="absolute bottom-[9px] left-[8px] top-0 w-[1px] bg-[#e8e8ed]"></div>
                  </li>
                  <li className="mt-1 flex list-none items-center rounded-[9px] py-[4px] text-gray-900">
                    <svg
                      className="h-4 w-4 text-gray-700"
                ...
                <ul className="mb-[10px] flex flex-col">
                  <hr className="w-full border-[#e8e8ed]" />
                  <li className="mt-1 flex list-none items-center rounded-[9px] py-[2px] text-gray-900">
                    <div className="inline-flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full bg-[#898FA9] pl-[0.5px] text-[7px] leading-[6px] text-white">
                      R
                    </div>
              ...
              <div className="flex flex-col bg-white p-[18px] text-[#667380]">
                {step === 1 ? (
                  <div>
                    <motion.span
                      initial={{ opacity: 0, y: 10 }}
                      ...
                      key={selected.id}
                      className="absolute text-[14px] font-semibold leading-[18px] text-[#1a2b3b]"
                    >
                      {selected.name} Questions
                    </motion.span>

                    <ul className="mt-[28px] flex">
                      <li className="max-w-[400px] list-none">
                ...
                {step === 2 && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
                    className="relative mt-[12px] flex h-[80%] rounded-lg bg-gray-100 shadow-md ring-1 ring-gray-900/5"
                  >
                    {selectedInterviewer.name === "John" ? (
                      <motion.img
                        initial={{ opacity: 0, y: 10 }}
                        ...
                        transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
                        key="John"
                        src="/placeholders/John.png"
                        alt="John's Interviewer Profile"
                        className="absolute left-6 top-6 aspect-video w-[30%] rounded bg-gray-700 object-cover shadow-md ring-1 ring-gray-900/5"
                      />
                    ) : selectedInterviewer.name === "Richard" ? (
                      <motion.img
                        initial={{ opacity: 0, y: 10 }}
                      ...
                      <motion.img
                        ...
                        transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
                        key="Sarah"
                        src="/placeholders/Sarah.png"
                        alt="Sarah's Interviewer Profile"
                        className="absolute left-6 top-6 aspect-video w-[30%] rounded bg-gray-700 object-cover shadow-md ring-1 ring-gray-900/5"
                      />
                    ) : (
                      <div className="absolute left-6 top-6 aspect-video w-[30%] rounded bg-gray-700"></div>
                    )}
                    <div className="absolute bottom-10 left-1/2 h-8 w-8 -translate-x-1/2 translate-y-1/2 transform rounded-full bg-red-400 ring-4 ring-white md:h-12 md:w-12"></div>
                  </motion.div>
                )}
                {step === 1 && (
                  <ul className="mt-[12px] flex items-center space-x-[2px]">
                    <svg
                      className="h-4 w-4 text-[#1a2b3b]"
                      fill="none"
                      viewBox="0 0 24 24"
                    >
                      <path
                ...
                {step === 1 &&
                  (selected.name === "Behavioral" ? (
                    <motion.ul
                      ...
                      transition={{ duration: 0.5, ease: [0.23, 1, 0.32, 1] }}
                      key={selected.id}
                      className="mt-3 grid grid-cols-3 gap-2 xl:grid-cols-3"
                    >
                      <li className="relative flex list-none items-stretch text-left">
                        <div className="group relative w-full">
                          <div className="relative mb-2 flex h-full max-h-[200px] w-full cursor-pointer items-start justify-between rounded-lg p-2 font-medium transition duration-100">
                            ...
                            <div className="relative flex h-full flex-col overflow-hidden">
                              ...
                              <p className="text-wrap grow text-[7px] font-normal">
                ...
                {step === 1 && (
                  <div className="mt-auto space-y-2 md:space-y-5">
                    <nav
                      className="mb-[10px] flex items-center justify-between border-t border-gray-200 bg-white px-1 py-[2px]"
