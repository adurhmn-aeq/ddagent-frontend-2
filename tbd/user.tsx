            ...
            <div className="h-full w-full items-center justify-center flex flex-col">
                ...
                >
                  ...
                  <p className="text-[14px] leading-[20px] text-[#fff] font-bold my-4">
                    Please enter your full name and email address to continue.
                  </p>
                  <div>
                    <div>
                        <input 
